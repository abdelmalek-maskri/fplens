...
const navItems = [
  {
    section: "PREDICTIONS",
    items: [
      { name: "Dashboard", icon: Icons.predictions, path: "/" },
      { name: "Optimal XI", icon: Icons.optimalXI, path: "/optimal-xi" },
    ]
  },
  {
    section: "PLANNING",
    items: [
      ...
      { name: "Transfers", icon: Icons.transfers, path: "/transfers" },
      { name: "Chip Advisor", icon: Icons.chipAdvisor, path: "/chip-advisor" },
      { name: "Season Planner", icon: Icons.seasonPlanner, path: "/season-planner" },
  ...
  },
  {
    ...
    items: [
      ...
      { name: "News & Sentiment", icon: Icons.news, path: "/news" },
  ...
  },
  {
    section: "ANALYSIS",
    items: [
      { name: "Model Insights", icon: Icons.insights, path: "/insights" },
    ]
  }
];
