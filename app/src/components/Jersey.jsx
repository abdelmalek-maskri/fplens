...
export const TEAM_KITS = {
  ...
  BRE: { body: "#E30613", sleeves: "#E30613", collar: "#FFFFFF", accent: "#FFFFFF", pattern: "stripes", stripeColor: "#FFFFFF", gk: "#1a1a1a" },
  BHA: { body: "#0057B8", sleeves: "#0057B8", collar: "#FFFFFF", accent: "#FFFFFF", pattern: "stripes", stripeColor: "#FFFFFF", gk: "#e8d44d" },
  ...
  FUL: { body: "#FFFFFF", sleeves: "#000000", collar: "#CC0000", accent: "#000000", text: "#000000", gk: "#e8d44d" },
  ...
  NEW: { body: "#241F20", sleeves: "#241F20", collar: "#241F20", accent: "#FFFFFF", pattern: "stripes", stripeColor: "#FFFFFF", gk: "#e8d44d" },
  NFO: { body: "#E53233", sleeves: "#E53233", collar: "#FFFFFF", accent: "#FFFFFF", gk: "#e8d44d" },
  SOU: { body: "#D71920", sleeves: "#D71920", collar: "#FFFFFF", accent: "#FFFFFF", pattern: "stripes", stripeColor: "#FFFFFF", gk: "#e8d44d" },
  TOT: { body: "#FFFFFF", sleeves: "#FFFFFF", collar: "#132257", accent: "#132257", text: "#132257", gk: "#1a1a1a" },
  WHU: { body: "#7A263A", sleeves: "#1BB1E7", collar: "#7A263A", accent: "#1BB1E7", gk: "#e8d44d" },
  WOL: { body: "#FDB913", sleeves: "#FDB913", collar: "#231F20", accent: "#231F20", text: "#231F20", gk: "#2ecc71" },
};

const DEFAULT_KIT = { body: "#555", sleeves: "#555", collar: "#333", accent: "#777", gk: "#4bc8a0" };
...
export default function Jersey({ teamName, position, isCaptain, isVice, status }) {
  ...
  const kit = isGK
    ? { body: kitDef.gk, sleeves: kitDef.gk, collar: "#1a1a1a", accent: "#333", text: isLightColor(kitDef.gk) ? "#1a1a1a" : "#ffffff" }
    : kitDef;
  ...
  return (
    <div className="relative">
      <svg viewBox="0 0 80 70" className="w-[62px] h-[54px] drop-shadow-lg">
        ...
        <path d="M26 16 L14 22 Q6 26 4 32 V34 Q4 36 6 36 H15 V26 L26 20 Z" fill={`url(#sh${uid})`} />
        <path d="M54 16 L66 22 Q74 26 76 32 V34 Q76 36 74 36 H65 V26 L54 20 Z" fill={`url(#sh${uid})`} />

        {/* Collar */}
        <path d="M26 16 L34 9 Q40 17 46 9 L54 16 Z" fill={kit.collar} />
        <path d="M34 9 Q40 19 46 9" fill="none" stroke="rgba(0,0,0,0.12)" strokeWidth="0.8" strokeLinecap="round" />

        {/* Accent details */}
        <line x1="24" y1="17" x2="12" y2="25" stroke={kit.accent} strokeWidth="2.5" opacity="0.55" strokeLinecap="round" />
        <line x1="56" y1="17" x2="68" y2="25" stroke={kit.accent} strokeWidth="2.5" opacity="0.55" strokeLinecap="round" />
        ...
        <path d="M26 16 L14 22 Q6 26 4 32 V34 Q4 36 6 36 H15 V26 L26 20" fill="none" stroke="rgba(0,0,0,0.06)" strokeWidth="0.5" />
        <path d="M54 16 L66 22 Q74 26 76 32 V34 Q76 36 74 36 H65 V26 L54 20" fill="none" stroke="rgba(0,0,0,0.06)" strokeWidth="0.5" />
